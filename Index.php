    ...
    <div class="aa-slider">  
        <div class="aa-slider-area">
          <div id="sequence" class="seq">
           ...
           <li>
              <div class="seq-model">
                <img data-seq src="img/banner-3.jpg" alt="Wristwatch slide img" />
            </div>
            <div class="seq-title">
        ...
        <li>
          <div class="seq-model">
            <img data-seq src="img/banner-2.jpg" alt="Women Jeans slide img" />
        </div>
        <div class="seq-title">
            <span data-seq>Save Up to 75% Off</span>                
    ...
    <li>
      <div class="seq-model">
        <img data-seq src="img/banner-4.jpg" alt="Shoes slide img" />
    </div>
    <div class="seq-title">
        <span data-seq>Save Up to 75% Off</span>                
